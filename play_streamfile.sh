...
DISPLAY=':0' SDL_AUDIODRIVER="alsa" AUDIODEV='hdmi:CARD=PCH,DEV=0' /home/ndi/bin/ffplay -af aresample=ocl=stereo -fs -f libndi_newtek -allow_video_fields false -i `cat /home/ndi/streamname.txt`  > /dev/null 2>&1 < /dev/null
