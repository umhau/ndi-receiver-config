...
NDI_STREAM_NAME="${1@Q}"             # pass the stream name to the shell script
STARTTIME=$(date +%s)
...
# customize locally.
ssh ndi@192.168.1.112 "bash /home/ndi/play.sh $NDI_STREAM_NAME &"
ssh ndi@192.168.1.80  "bash /home/ndi/play.sh $NDI_STREAM_NAME &"
ssh ndi@192.168.1.82  "bash /home/ndi/play.sh $NDI_STREAM_NAME &"