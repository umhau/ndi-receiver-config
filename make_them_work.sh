...
bash /home/ndi/ndi-receiver-config/turn_on_and_play.sh  192.168.1.112 78:45:c4:13:be:9e "$NDI_STREAM_NAME" &
bash /home/ndi/ndi-receiver-config/turn_on_and_play.sh  192.168.1.80  00:1d:09:8e:e1:36 "$NDI_STREAM_NAME" &
bash /home/ndi/ndi-receiver-config/turn_on_and_play.sh  192.168.1.82  c8:1f:66:1c:97:ee "$NDI_STREAM_NAME" &
